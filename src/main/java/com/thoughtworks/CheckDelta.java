...
import com.thoughtworks.deltameasures.DeltaMeasure;
import com.thoughtworks.deltameasures.DeltaMeasureFactory;
...
public class CheckDelta implements PostJob {

    private static final String CHECK_DELTA_CONF_FILE = "/checkDelta.conf";
    private static final DeltaMeasureFactory factory = new DeltaMeasureFactory();
    ...
    private List<DeltaMeasure> getDeltaMeasures(SensorContext sensorContext) {
        ...
        try {
            ...
            while((line = br.readLine()) != null) {
                ...
                deltaMeasures.add(factory.getDeltaMeasure(measure, Double.valueOf(metricAndThreshold[1])));
            }
